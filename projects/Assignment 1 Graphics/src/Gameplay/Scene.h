...
namespace Gameplay {
	...
	public:
		...
		void SetColorLUT(const Texture3D::Sptr& texture, int nummode);
		const Texture3D::Sptr& GetColorLUT(int nummode) const;
	...
	protected:
		...
		Texture3D::Sptr               _colorColdCorrection;

		Texture3D::Sptr               _colorBWCorrection;
